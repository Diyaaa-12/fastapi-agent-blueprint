...
| `chatbot_with_memory/` | Multi-turn chatbot with session memory and history replay | LLM-calling | 🟡 [#251](https://github.com/Mr-DooSun/fastapi-agent-blueprint/issues/251) |
